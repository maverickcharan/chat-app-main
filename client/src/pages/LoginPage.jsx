 ...
 const onSubmitHandler =(event)=> {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/20 text-white border-gray-500 p-6 flex
     flex-col gap-6 rounded-lg shadow-lg'>

        <h2 className='font-medium text-2xl flex justify-between items-center'>
          {currState}   
          {isDataSubmitted && 
          <img onClick={()=> setIsDataSubmitted(false)} src={assets.arrow_icon} 
        ...
        {!isDataSubmitted && (
          <>
            <input
              ...
              required
              className='p-2 border border-gray-500 rounded-md focus:ring-indigo-500'
            />
        ...
        <div className='flex flex-col gap-2'>
          {currState === "Sign up" ? (
            <p className='text-sm text-gray-600'>Already have account?
